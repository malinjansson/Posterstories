...
require_once('Models/CartItem.php');
    class Database {
        ...
        function insertProduct($title, $description, $price, $img, $stockLevel, $categoryName, $popularity, $active){
            $sql = "INSERT INTO Products (title, description, price, img, stockLevel, categoryName, popularity, active) VALUES (:title, :description, :price, :img, :stockLevel, :categoryName, :popularity :active)";
